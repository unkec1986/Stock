...
angular.module('stockDogApp').service('WatchlistService', function WatchlistService () {
  // [1] Helper: Load watchlists from localStorage
  var loadModel = function () {
    var model = {
      watchlists: localStorage['StockDog.watchlist'] ? JSON.parse(localStorage['StockDog.watchlist']) : [],
  ...
  var saveModel = function () {
    localStorage['StockDog.watchlist'] = JSON.stringify(Model.watchlists);
  ...
  // [5] Save a new watchlist to watchlists to model
